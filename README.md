...
AetherIoT 的公开产品官网。AetherIoT 是面向物理空间的开源、人工智能原生运行平台，目标是不再让用户逐项配置设备：用户描述生活需求，智能体提出可检查的自动化方案，再由边缘端按照权限和安全规则在本地执行。官网说明 AetherEdge、AetherCloud 和 AetherContracts 的不同职责，并明确区分已经交付的基础能力与仍在开发的家庭对话配置体验。
